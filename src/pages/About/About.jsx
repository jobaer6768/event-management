    ...
    return (
        <div className="flex justify-center items-center h-[90vh]">
            <div className="space-y-8 text-center py-10 px-6">
                ...
                <p className="mt-2">As the premier event planning company in the area, we know that it’s not “one size fits all”. Each event and client is unique and we believe our services should be as well. We know that it should be “Can I hire a planner?” not “Can I afford one?”.</p>
